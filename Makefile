# hash.sh needs a GNU preprocessor. Linux g++ and Git Bash's g++ are; Apple's
# is not, so pick a Homebrew gcc when present. Kept here rather than in hash.sh,
# which prints in the notebook and must stay short enough to retype.
...
help:
	@echo "Overflow-Masters ICPC notebook"
	@echo ""
